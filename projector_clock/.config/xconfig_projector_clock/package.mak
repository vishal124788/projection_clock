...
override PKGDIR = xconfig_projector_clock
...
C:/ti/bios_6_45_00_20/packages/ti/targets/ITarget.xs:
package.mak: C:/ti/bios_6_45_00_20/packages/ti/targets/ITarget.xs
C:/ti/bios_6_45_00_20/packages/ti/targets/C28_large.xs:
package.mak: C:/ti/bios_6_45_00_20/packages/ti/targets/C28_large.xs
C:/ti/bios_6_45_00_20/packages/ti/targets/C28_float.xs:
package.mak: C:/ti/bios_6_45_00_20/packages/ti/targets/C28_float.xs
C:/ti/bios_6_45_00_20/packages/ti/targets/package.xs:
package.mak: C:/ti/bios_6_45_00_20/packages/ti/targets/package.xs
C:/ti/bios_6_45_00_20/packages/ti/targets/arm/elf/IArm.xs:
package.mak: C:/ti/bios_6_45_00_20/packages/ti/targets/arm/elf/IArm.xs
C:/ti/bios_6_45_00_20/packages/ti/targets/arm/elf/package.xs:
package.mak: C:/ti/bios_6_45_00_20/packages/ti/targets/arm/elf/package.xs
...
ti.targets.arm.elf.packageBase ?= C:/ti/bios_6_45_00_20/packages/ti/targets/arm/elf/
...
package/%.xdc.inc package/%_xconfig_projector_clock.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_projector_clock" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: projector_clock.pem4f

-include package/cfg/projector_clock_pem4f.mak
-include package/cfg/projector_clock_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/projector_clock_pem4f.dep
endif
projector_clock.pem4f: package/cfg/projector_clock_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
projector_clock.pem4f package/cfg/projector_clock_pem4f.c: .libraries,em4f
endif

package/cfg/projector_clock_pem4f.c package/cfg/projector_clock_pem4f.h package/cfg/projector_clock_pem4f.xdl: override _PROG_NAME := projector_clock.xem4f
package/cfg/projector_clock_pem4f.c: package/cfg/projector_clock_pem4f.cfg
package/cfg/projector_clock_pem4f.xdc.inc: package/cfg/projector_clock_pem4f.xdl
package/cfg/projector_clock_pem4f.xdl package/cfg/projector_clock_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/projector_clock_pem4f.cfg
	-$(RM) package/cfg/projector_clock_pem4f.dep
	-$(RM) package/cfg/projector_clock_pem4f.c
	-$(RM) package/cfg/projector_clock_pem4f.xdc.inc

clean,em4f::
	-$(RM) projector_clock.pem4f
.executables,em4f .executables: projector_clock.xem4f

projector_clock.xem4f: |projector_clock.pem4f

-include package/cfg/projector_clock.xem4f.mak
projector_clock.xem4f: package/cfg/projector_clock_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/projector_clock_pem4f.oem4f   package/cfg/projector_clock_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
projector_clock.xem4f: export C_DIR=
projector_clock.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
projector_clock.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

projector_clock.test test,em4f test: projector_clock.xem4f.test

projector_clock.xem4f.test:: projector_clock.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 projector_clock.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.projector_clock.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,projector_clock.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) projector_clock.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
projector_clock_pem4f.oem4f,copy : package/cfg/projector_clock_pem4f.oem4f
projector_clock_pem4f.sem4f,copy : package/cfg/projector_clock_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_projector_clock
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_projector_clock.tar.dep
endif
package/rel/xconfig_projector_clock/xconfig_projector_clock/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_projector_clock/xconfig_projector_clock/package/package.rel.xml: package/build.cfg
package/rel/xconfig_projector_clock/xconfig_projector_clock/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_projector_clock/xconfig_projector_clock/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_projector_clock.tar: package/rel/xconfig_projector_clock.xdc.inc package/rel/xconfig_projector_clock/xconfig_projector_clock/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_projector_clock.xdc.inc,package/rel/xconfig_projector_clock.tar.dep)


release release,xconfig_projector_clock: all xconfig_projector_clock.tar
clean:: .clean
	-$(RM) xconfig_projector_clock.tar
	-$(RM) package/rel/xconfig_projector_clock.xdc.inc
	-$(RM) package/rel/xconfig_projector_clock.tar.dep
